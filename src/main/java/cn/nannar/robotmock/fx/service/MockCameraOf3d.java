...
public class MockCameraOf3d {
    ...
    public RealTimeDataDTO.CameraOf3d getCamera3d(){
        RealTimeDataDTO.CameraOf3d cameraOf3d = new RealTimeDataDTO.CameraOf3d();
        cameraOf3d.setStatus(status);
        cameraOf3d.setTroubleCodeList(getTroubleCodeList());
        return cameraOf3d;
    }
}
